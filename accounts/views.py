...
def register(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            send_email.send()
            #messages.success(request, 'Thank you for Registration, We have sent you a verification email. Please verify it')
    ...
    if request.method == 'POST':
        ...
        if new_password == confirm_password:
            ...
            if success:
                ...
                user.save()
                # auth.Logout(request)  -- To logout when password is changed but django logs out as of default
